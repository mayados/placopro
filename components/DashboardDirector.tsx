      ...
      <section aria-labelledby="data-title" className="space-y-6">
        ...
        <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-3 md:gap-4 text-primary">
          <article className=" p-6 rounded-lg text-center">
            ...
            />
            <p className="text-2xl font-semibold">{workSites}</p>
            <p className="mt-1">Chantiers en cours</p>
          </article>
          ...
          <article className=" p-6 rounded-lg text-center">
            ...
            <p className="mt-1">Employés</p>
          </article>
        </div>
      </section>
      <section aria-labelledby="weather-title" className="space-y-6">
        <div className="flex items-center gap-2">
          <FontAwesomeIcon
            icon={faDatabase}
            className="w-5 h-5 text-primary"
          />
          <h2 id="weather-title" className="text-xl font-semibold text-primary">
